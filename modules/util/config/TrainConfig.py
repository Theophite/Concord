...
class TrainConfig(BaseConfig):
    ...
    concord_embedding_quality_mode: str  # "hard" = subject steps fully orthogonal to the tag subspace (no motion along it). "one_sided" = block only the component moving TOWARD a tag direction, leaving a subject free to move away (toward good). Default hard.
