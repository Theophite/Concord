...
class CloudTab:
    ...
    def __init__(self, master, train_config: TrainConfig, ui_state: UIState, parent):
        ...
        components.label(self.frame, 2, 0, "File sync method",
                         tooltip="Choose NATIVE_SCP to use tok.exe to transfer files. FABRIC_SFTP uses the Paramiko/Fabric SFTP implementation for file transfers instead.")
        ...
        components.label(self.frame, 8, 0, "SSH password",
                         tooltip="SSH password for password-based authentication. If you try to use native tok requires sshpass to be installed. Leave empty to use key-based authentication.")
