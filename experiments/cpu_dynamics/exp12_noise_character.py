"""Exp 12: noise with the character of augmentation — the hierarchy test.
...
if __name__ == "__main__":
    ...
    print("exp 12 — 4k, 30% noise, 80ep, NS kappa=150 lr 1e-2; refs: "
    ...
    json.dump(out, open("exp12_results.json", "w"), indent=1)
