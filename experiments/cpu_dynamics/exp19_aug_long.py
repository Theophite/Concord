"""Exp 19: augmentation + longer horizon — does the gate win back its keep?

Exp 18's findings (long window ~ close the gate; gateless friction optimal)
were earned in the NO-diversity corner. The standing claim from exps 10/17:
...
if __name__ == "__main__":
    ...
    json.dump(out, open("exp19_results.json", "w"), indent=1)
