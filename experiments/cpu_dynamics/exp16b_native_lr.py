"""Exp 16b: native Muon on the same fine lr grid — apportioning the flatness.

Exp 16 showed the Concord-NS drive is lr-insensitive across a decade. Two
...
Same protocol as exp 16: 4k x 25ep, clean, aug off/on, 3 seeds, deploy n/a
...
from exp16_ns_lr import EPOCHS, LRS
...
if __name__ == "__main__":
    ...
    json.dump({f"{int(a)}|{lr}": v for (a, lr), v in out.items()},
              open("exp16b_results.json", "w"), indent=1)
